...
//
// jfdi uses higher-order functions extensively -- constructor functions that
// return Generator functions, which are called to recursively produce the
// desired result.  For example, to define a JSON object, use the Object
// function with a template Map.  If any values in the Map are also Generators,
